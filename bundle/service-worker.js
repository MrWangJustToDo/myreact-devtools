(function () {
    ...
    var portPip = function (id, port1, port2) {
        ...
        port1.postMessage({ type: coreExports.MessageWorkerType.init });
        port2.postMessage({ type: coreExports.MessageWorkerType.init });
    };
...
//# sourceMappingURL=service-worker.production.js.map
